...
bool output_data = false,string outf = "MC_data_out.csv",string outf_est = "MC_est_out.csv"){
	...
	cout<<"T,"<<"ave_ene,"<<"sigma_ene,"<<"ave_mz,"<<"sigma_mz,"<<"ave_mz_sq,"
	...
	{	
		...
		cout << 1/beta[beta_idx] <<"," << ave_ene << "," << alpha * stderr_ene << "," 
...
int main(int argc,char *argv[]){
	...
	string input_XML = (argc) ? argv[1] : "../InputParam_MC.xml";
